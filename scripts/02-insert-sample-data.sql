-- Datos de ejemplo para GYM360 Dashboard
USE gym360_db;

-- Super Admin
INSERT INTO usuarios_sistema (id, email, password_hash, nombre, apellido, rol, sucursal_id) VALUES
(1, 'dueno@gym360.com', 'c3VwZXJhZG1pbjEyMw==', 'Propietario', 'Sistema', 'super_admin', NULL)
...
-- Sucursales
INSERT INTO sucursales (id, nombre, direccion, telefono, email, capacidad_maxima, fecha_apertura) VALUES
...
-- Planes de membresía
INSERT INTO planes_membresia (id, nombre, descripcion, precio_mensual, duracion_meses) VALUES
...
-- Entrenadores
INSERT INTO entrenadores (id, nombre, apellido, email, telefono, especialidades, fecha_contratacion, salario_base, sucursal_id) VALUES
...
-- Tipos de clases
INSERT INTO tipos_clases (id, nombre, descripcion, duracion_minutos, capacidad_maxima) VALUES
...
-- Miembros
INSERT INTO miembros (id, numero_miembro, nombre, apellido, email, telefono, fecha_nacimiento, genero, fecha_registro, sucursal_id) VALUES
...
-- Membresías
INSERT INTO membresias (id, miembro_id, plan_id, sucursal_id, fecha_inicio, fecha_fin, precio_pagado, estado) VALUES
...
-- Clases
INSERT INTO clases (id, tipo_clase_id, entrenador_id, sucursal_id, fecha, hora_inicio, hora_fin, capacidad_maxima, inscritos_actuales) VALUES
...
ON DUPLICATE KEY UPDATE
    tipo_clase_id = VALUES(tipo_clase_id),
    ...
    capacidad_maxima = VALUES(capacidad_maxima),
    inscritos_actuales = VALUES(inscritos_actuales);

-- Inscripciones
INSERT INTO inscripciones_clases (id, clase_id, miembro_id, asistio) VALUES
(1, 1, 1, TRUE),
(2, 1, 2, TRUE),
(3, 1, 3, FALSE),
(4, 2, 1, TRUE),
...
-- Pagos
INSERT INTO pagos (id, membresia_id, monto, fecha_pago, fecha_vencimiento, metodo_pago, estado) VALUES
...
-- Asistencias
INSERT INTO asistencias (id, miembro_id, sucursal_id, fecha_entrada, fecha_salida, duracion_minutos) VALUES
